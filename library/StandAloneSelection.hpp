...
class StandAloneSelection : public MdnObserver {
...
public:
    ...
    StandAloneSelection(Mdn2d* ref=nullptr): MdnObserver(ref) {}
    ...
    // * Selection operations
        ...
        // Destructor
        ~StandAloneSelection() { if (m_ref) m_ref->unregisterObserver(this); }
